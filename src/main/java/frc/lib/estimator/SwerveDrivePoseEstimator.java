...
import frc.lib.interpolation.TimeInterpolatableBuffer;
...
public class SwerveDrivePoseEstimator {
    ...
    public Pose2d updateWithTime(double currentTimeSeconds, Rotation2d gyroAngle, SwerveModuleState... moduleStates) {
        ...
        var fieldRelativeVelocities =
                new Translation2d(chassisSpeeds.vxMetersPerSecond, chassisSpeeds.vyMetersPerSecond).rotateBy(angle);
