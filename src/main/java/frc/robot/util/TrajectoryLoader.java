...
public class TrajectoryLoader {
    ...
    private static final String FUN_STUFF_PATH = "funstuff";
    ...
    private LazyPathPlannerTrajectory funStuff;
    ...
    public TrajectoryLoader() {
        ...
        funStuff = new LazyPathPlannerTrajectory(FUN_STUFF_PATH, 5, 2.5);
    }

    public PathPlannerTrajectory getFunStuff() {
        return funStuff.getTrajectory();
    }
